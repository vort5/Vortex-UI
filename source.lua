...
local toggleCorner = Instance.new("UICorner")
        ...
        -- Add this function inside the library:CreateTab(name) function, alongside the other UI element creation functions
...
function tab:CreateDropdown(text, options, default, callback)
    ...
    selectedOption.Size = UDim2.new(0, 120, 0, 25)
    selectedOption.Position = UDim2.new(1, -130, 0.5, -12.5)
    selectedOption.BackgroundColor3 = THEME.ACCENT
    selectedOption.Text = default or options[1] or "Select..."
    selectedOption.TextColor3 = THEME.TEXT
    selectedOption.TextSize = 12
    selectedOption.Font = Enum.Font.Gotham
    selectedOption.Parent = dropdownFrame
    
    storeOriginalProperties(selectedOption)
    
    local selectedCorner = Instance.new("UICorner")
    selectedCorner.CornerRadius = UDim.new(0, 4)
    selectedCorner.Parent = selectedOption
    ...
    dropdownArrow.Parent = selectedOption
    
    storeOriginalProperties(dropdownArrow)
    
    local optionsFrame = Instance.new("Frame")
    optionsFrame.Name = "Options"
    optionsFrame.Size = UDim2.new(0, 120, 0, 0)
    optionsFrame.Position = UDim2.new(1, -130, 1, 5)
    optionsFrame.BackgroundColor3 = THEME.ACCENT
    ...
    storeOriginalProperties(optionsFrame)
    ...
    local function createOption(optionText)
        ...
        storeOriginalProperties(option)
        
        option.MouseEnter:Connect(function()
            TweenService:Create(option, ANIMS.FADE, {
                BackgroundColor3 = THEME.HOVER
            }):Play()
        end)
